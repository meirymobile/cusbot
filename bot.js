const modalData = {
    'alcohol': {
        ...
        body: `הפטור ממס ניתן לנוסע אחד מעל גיל 18 במגבלות ההבאות:
            ...
            <div class="example-box">
                ...
                אם הבאתם 3 בקבוקי יין, חרגתם בבקבוק אחד ויש לעבור במסלול האדום. לא ניתן להביא "קצת יותר" ללא דיווח במכס! 
            </div>`
    },
    'tobacco': {
        icon: '🚬',
    ...
    'clothes': {
        ...
        body: `כמויות מסוג זה נכללות בפטור הכולל של עד $200 (ביחד עם שאר הפריטים).
            ...
            <div class="example-box">
                <strong>💡 דוגמה:</strong><br>
                אם המזוודה שלכם מכילה 15 חולצות חדשות וזהות, הדבר מעלה חשד לייבוא מסחרי. יש לעבור במסלול האדום לדיווח, גם אם העלות לא עוברת את הרף.
            </div>`
    },
    'food': {
        icon: '🍏',
...
function processBotResponse(text) {
    ...
    if (clothesMatch) {
        ...
        if (count > 10) {
            warnings.push(`👕 <strong>כמות ${type}:</strong> הבאת ${count} יחידות. המכס בודק האם הכמות סבירה לשימוש אישי. מעל 12-15 יחידות זהות עלול לעורר חשד לייבוא מסחרי. אם אלו פריטים זהים באריזה, חובה לדווח.`);
